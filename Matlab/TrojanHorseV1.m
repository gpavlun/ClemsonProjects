...
winner=0;
Turn=0;
while winner==0&&Turn<9 %Swiggles the cardometer
    cont2=0;
    while cont2==0
        cont1=0;
        while cont1==0
        x=input('X-which row?','s');%four hundred and fifty-six years in the simulcrum
        if (isempty(x)==0)&&(((1==strcmp(x,'1'))||(1==strcmp(x,'2'))||(1==strcmp(x,'3')))||((1==strcmpi(x,'one'))||(1==strcmpi(x,'two'))||(1==strcmpi(x,'three'))))
            cont1=1;
        else
            x='';
            fprintf('\nPick rows 1, 2, or 3.\n\n')
        ...
        if((1==strcmp(x,'1'))||(1==strcmp(x,'2'))||(1==strcmp(x,'3')))
        x=str2num(x);
        else
            if 1==strcmpi(x,'one')
                x=1;
        ...
        cont1=0;
        while cont1==0
        y=input('X-which column?','s');%simulates the fulcaity
        if (isempty(y)==0)&&(((1==strcmp(y,'1'))||(1==strcmp(y,'2'))||(1==strcmp(y,'3')))||((1==strcmpi(y,'one'))||(1==strcmpi(y,'two'))||(1==strcmpi(y,'three'))))
            cont1=1;
        else
            x='';
        ...
        if((1==strcmp(y,'1'))||(1==strcmp(y,'2'))||(1==strcmp(y,'3')))
        y=str2num(y);
        else
            if 1==strcmpi(y,'one')
                y=1;
    ...
    cont2=0;
    if (board(1,1)=='X'&&board(1,2)=='X'&&board(1,3)=='X')||(board(2,1)=='X'&&board(2,2)=='X'&&board(2,3)=='X')||(board(3,1)=='X'&&board(3,2)=='X'&&board(3,3)=='X')||(board(1,1)=='X'&&board(2,1)=='X'&&board(3,1)=='X')||(board(1,2)=='X'&&board(2,2)=='X'&&board(3,2)=='X')||(board(1,3)=='X'&&board(2,3)=='X'&&board(3,3)=='X')||(board(1,1)=='X'&&board(2,1)=='X'&&board(3,1)=='X')||(board(1,1)=='X'&&board(2,2)=='X'&&board(3,3)=='X')||(board(1,3)=='X'&&board(2,2)=='X'&&board(3,1)=='X')
        winner='X';
    else  
        while cont2==0&&Turn<9% Delete if you want to
            cont1=0;
            while cont1==0
            x=input('O-which row?','s');
            if (isempty(x)==0)&&(((1==strcmp(x,'1'))||(1==strcmp(x,'2'))||(1==strcmp(x,'3')))||((1==strcmpi(x,'one'))||(1==strcmpi(x,'two'))||(1==strcmpi(x,'three'))))
               cont1=1;
            else
                x='';
            ...
            if((1==strcmp(x,'1'))||(1==strcmp(x,'2'))||(1==strcmp(x,'3')))
                ...
                if 1==strcmpi(x,'one')
                    ...
                    if 1==strcmpi(x,'two')
                        ...
                        if 1==strcmpi(x,'three')%twenty seven stab wounds
                            x=3;
                        end
                    end
                end
        ...
        if (board(1,1)=='O'&&board(1,2)=='O'&&board(1,3)=='O')||(board(2,1)=='O'&&board(2,2)=='O'&&board(2,3)=='O')||(board(3,1)=='O'&&board(3,2)=='O'&&board(3,3)=='O')||(board(1,1)=='O'&&board(2,1)=='O'&&board(3,1)=='O')||(board(1,2)=='O'&&board(2,2)=='O'&&board(3,2)=='O')||(board(1,3)=='O'&&board(2,3)=='O'&&board(3,3)=='O')||(board(1,1)=='O'&&board(2,1)=='O'&&board(3,1)=='O')||(board(1,1)=='O'&&board(2,2)=='O'&&board(3,3)=='O')||(board(1,3)=='O'&&board(2,2)=='O'&&board(3,1)=='O')
            winner='O';
        else
            winner=0;
        end
